export default {
  ...
  htmlCode: {
    fundRaising:
      '<p>Podpořte tento projekt vaším darem na transparentní účet <a href="https://ib.fio.sk/ib/transparent?a=2901594765&amp;l=ENGLISH" >SK3783300000002901594765/FIOBCZPPXXX</a> Srdcom Doma o.z.</p>' +
      '<ul>' +
      ...
      '</ul>',
    f6sComFollowWidget:
      '<a href="https://www.f6s.com/qesadila?follow=1" target="_blank" title="Follow Qesadila on F6S"><img src="https://www.f6s.com/images/f6s-follow-white.png" border="0" width="78" height="22 " alt="Follow Qesadila on F6S" style="width: 78px; height: 22px; padding: 0px; margin: 0px;" /></a>',
    projectOverview:
