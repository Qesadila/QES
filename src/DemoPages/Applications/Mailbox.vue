            ...
            <div class="app-inner-layout__wrapper">
                    ...
                    <div>
                        <div class="app-inner-layout__top-pane">
                            <div class="pane-left">
                                ...
                                <b-dropdown toggle-class="btn-icon btn-icon-only dropdown-toggle-no-caret" menu-class="dropdown-menu-lg" variant="link" no-caret>
                                    <span slot="button-content"><font-awesome-icon icon="angle-down" /></span>
                            ...
                            <div class="table-responsive">
                                <table class="text-nowrap table-lg mb-0 table table-hover align-middle">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <font-awesome-icon icon="tags" class="opacity-4" />
                                        </td>
                                        <td class="text-right">
                                            <font-awesome-icon icon="calendar-alt" class="opacity-4 mr-2" />
                                            7 Dec
                                        </td>
                                    </tr>
                                    <tr>
                ...
                <div class="app-inner-layout__sidebar card">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <button type="button" tabindex="0" class="center-elem dropdown-item">
