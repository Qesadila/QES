...
<script>
    ...
    export default {
        ...
        data: () => ({
            heading: 'Time picker',
            subheading: 'The v-time-picker is stand-alone component that can be utilized in many existing Vuetify components. It offers the user a visual representation for selecting the time.',
