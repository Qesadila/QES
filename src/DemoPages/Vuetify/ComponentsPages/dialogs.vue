    ...
    <div>
        ...
        <layout-wrapper>
            <demo-card heading="Basic"
                       subheading="A dialog contains two slots, one for its activator and one for its content (default). Good for Privacy Policies.">
                <dialogs1></dialogs1>
            </demo-card>
            <demo-card heading="Without activator"
                       subheading="If for some reason you are unable to use the activator slot, be sure to add the .stop modifier to the event that triggers the dialog.">
                <dialogs2></dialogs2>
            </demo-card>
...
<script>
    ...
    export default {
        ...
        data: () => ({
            heading: 'Dialog',
            subheading: 'The v-dialog component inform users about a specific task and may contain critical information, require decisions, or involve multiple tasks. Use dialogs sparingly because they are interruptive.',
